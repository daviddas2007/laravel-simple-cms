...
@section('title')
{{ getSetting('site_shortname') }} | Slider Group
@stop
...
@section('script')
 ...
 <script src="{{ URL::asset('public/admin/js/slider-group.js')}}"></script>
...
$(document).ready(function(){
    ...
    oTable = $('#example1').dataTable( {
        ...
        "sDom": 'R<>rt<ilp><"clear">',
        "bServerSide": true,
        "sAjaxSource": '{{URL::to("admin/sliders/groups/get")}}',
...
<div class="row">
    <div class="col-md-8">
       <div class="box">
           <div class="box-header">
              <h3 class="box-title">Slider Group Listings</h3>
    ...
    <div class="col-md-4">
      <div id="response">
         @include('backend.slider-group.create')
      </div>  
    </div>
